...
const mdiIconMap: Record<string, string> = {
  ...
  mip: mdiLayersTriple,
  segmentation: mdiChartBellCurveCumulative,
  'segmentation-threshold': mdiContrastCircle,
  'segmentation-voi': mdiRectangleOutline,
