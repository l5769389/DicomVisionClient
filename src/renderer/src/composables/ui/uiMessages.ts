...
export const uiMessages = {
  'zh-CN': {
    ...
    settings: {
      ...
      scaleBarColor: '比例尺颜色',
      measurementStyleTitle: '测量及标注',
      measurementStyleDesc: '设置测量和标注的颜色、粗细、线型与默认作用范围。',
  ...
  'en-US': {
    ...
    settings: {
      ...
      measurementStyleTitle: 'Measurement & Annotation',
      measurementStyleDesc: 'Set measurement and annotation colors, stroke width, line styles, and default scope.',
